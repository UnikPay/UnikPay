...
public class Config {
    ...
    public static String ALLEREDE_SUB = "Du har allerede et abonnement på denne pakke";
    public static String RATELIMIT = "Du har sendt en request indenfor de sidste 15 sekunder";
}
