...
public class EffAccept extends Effect {
    ...
    static {
        Skript.registerEffect(EffAccept.class, "unikpay accepter betaling %unikid%");
    }
    ...
    protected void execute(@NotNull Event e) {
        ...
        String url = Main.getInstance().getConfigSystem().getUrl() + "/v1/request/" + id.getSingle(e) + "/complete";
